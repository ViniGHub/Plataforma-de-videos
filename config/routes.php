...
use Alura\Mvc\Controller\ChangeUserController;
...
use Alura\Mvc\Controller\ChangeUserFormController;
...
return [
    ...
    'GET|/change-login' => ChangeUserFormController::class,
    'POST|/change-login' => ChangeUserController::class
];